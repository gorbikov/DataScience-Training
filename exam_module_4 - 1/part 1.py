...
for column in columns:
    generate_histogram(currentScriptName, originalTrainCvDf, "originalTrainCvDf", column)
...
for column in columns:
    generate_boxplot(currentScriptName, originalTrainCvDf, "originalTrainCvDf", column)
    generate_histogram(currentScriptName, originalTrainCvDf, "originalTrainCvDf", column)
...
generate_correlation_with_target(currentScriptName, trainCvDf, "trainCvDf", "mutation")
